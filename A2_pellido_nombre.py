...
Original file is located at
    https://colab.research.google.com/drive/1tBtmQRlNmEz66UxeN3hQL1dwncSHR3lO
"""
...
# 1. Genera un array con valores de 10 a 29
...
# 10: Dado un array de números aleatorios de tamaño 10, selecciona y muestra solo aquellos que sean mayores a 5.
...
# 12: Genera un gráfico de dispersión de las variables x y y = sin(x) + ruido Gaussiano.
...
# 13: Utiliza la función np.meshgrid para crear una cuadrícula y luego aplica la función
...
# 14: Crea un gráfico de dispersión con 1000 puntos aleatorios y utiliza la densidad de estos puntos
...
# 15: A partir de la misma función del ejercicio anterior, genera un gráfico de contorno lleno.
...
# 16: Añade etiquetas para los ejes y un título al gráfico de dispersión del ejercicio 12,
...
# 20: Experimenta con diferentes valores de bins (por ejemplo, 10, 30, 50) en un histograma y observa cómo cambia la representación.
